...
export const Footer = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto flex flex-col gap-10">
        <div className="flex items-center max-sm:flex-col max-md:items-start max-md:gap-4 justify-center gap-20">
            <a href="#" className="font-sen tracking-wider">Condiciones de uso y privacidad</a>
            <a href="#" className="font-sen tracking-wider">Política de cookies</a>
        </div>
        <div>
