...
function History() {
  ...
  return (
    <section className="scroll-section-outer history px-4 py-10 ">


      <div className="content-scroll " ref={triggerRef} >
        <div className="mt-12 max-xl:max-w-11/12 max-w-10/12 mx-auto  ">
       <h3 className="font-quick tracking-widest  max-xl:px-4 max-lg:text-center ">
        SOBRE NOSOTROS
       </h3>

      <h2 className="mb-4 mt-6  max-lg:mt-4 text-primary text-xl md:text-5xl max-lg:text-center   max-xl:px-4  tracking-widest font-sedan  mx-auto ">
        ...
        <article className="rounded-2xl  max-w-10/12  p-6 max-lg:w-full m-auto flex flex-col gap-6 max-sm:p-0 ">
         
          <p className="text-zinc-300 descp  max-2xl:px-2 tracking-widest leading-8 max-md:leading-4 text-xl max-sm:text-sm  break-words font-syne">
          ...
          <p className="text-zinc-300 descp  text-xl max-sm:text-sm  max-2xl:px-2 tracking-widest leading-8 max-md:leading-4 font-syne">
        ...
        <article className=" rounded-2xl  max-w-[2000px] max-xl:max-w-7xl   p-6 max-lg:w-full m-auto flex flex-col gap-2 max-lg:px-4">
           
            <p className="text-zinc-300 max-md:leading-4 leading-8 tracking-widest mb-2 text-xl max-sm:text-sm font-syne ">
            ...
            <p className="text-zinc-300 max-md:leading-4 leading-8 tracking-widest font-syne text-xl max-sm:text-sm ">
          ...
          <article className="  rounded-2xl  max-w-[2000px] max-xl:max-w-7xl  p-6 max-lg:w-full m-auto flex flex-col gap-2 max-lg:px-4">
            ...
            <p className="text-zinc-300 max-md:leading-4 leading-8 tracking-widest mb-2 text-xl font-syne max-sm:text-sm ">
            ...
            <p className="text-zinc-300 max-md:leading-4 leading-8 tracking-widest text-xl max-sm:text-sm font-syne ">
          ...
          <article className=" rounded-2xl    max-w-[2000px] max-xl:max-w-7xl p-6 max-lg:w-full m-auto flex flex-col gap-4 max-lg:px-4">
            ...
            <ul>
                <li className="lista text-zinc-300 max-md:leading-4 leading-8 text-xl max-sm:text-sm tracking-widest font-syne"><p><i className="ri-arrow-right-line"></i> Una empresa de joyería y exportación de oro y diamantes.</p></li>
                <li className="lista font-syne text-zinc-300 max-md:leading-4 leading-8 tracking-widest text-xl max-md:text-sm"><p><i className="ri-arrow-right-line"></i> Una barbería premium.</p></li>
                <li className="lista text-xl font-syne max-md:text-sm text-zinc-300 max-md:leading-4 leading-8 tracking-widest"><p><i className="ri-arrow-right-line"></i>Una agencia digital.</p></li>
                <li className="lista text-xl max-md:text-sm text-zinc-300 max-md:leading-4 leading-8 tracking-widest font-syne"><p><i className="ri-arrow-right-line"></i>Una compañía de logística y venta de partes de aviones.</p></li>
            </ul>
          </article>
